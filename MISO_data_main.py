...
#pras_filename = "VRE0.1_wind_2012base100%_48_1%tx_18%IRM_0GWstorage_LAonly_addgulfsolar"
load_scalar = 1  # how much to scale resulting load profile by... 1 should be default
target_IRM = 0.4  # as a fraction
use_target_IRM = True  #
storage_capacity = 0  # total storage capacity, in MW
#scale_transmission_capacity = 0.01  # rescales transmission capacities between zones
tx_list = [0.00,0.01,.1,.2,.3,.4,.5,.6,.7,.8,.9,1.]
#tx_list = [1.5,2.,2.5,3.]
...
for scale_transmission_capacity in tx_list:
    pras_filename = "VRE0.1_wind_2012base100%_48_"+str(int(scale_transmission_capacity*100))+"%tx_40%IRM_0GWstorage_LAonly_addgulfsolar"
    ...
    # HDF5_data.add_hybridized_resource(100, 6)
